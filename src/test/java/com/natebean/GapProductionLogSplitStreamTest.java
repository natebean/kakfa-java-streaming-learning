...
public class GapProductionLogSplitStreamTest {
    ...
    public void testReadOutput() {
        ...
        System.out.println(pl.getKafkaKey());
        System.out.println(gl.getKafkaKey());
        ...
        ConsumerRecord<byte[], byte[]> plRecord = productionLogFactory.create(ProductionLogProducer.SIMPLE_JSON_TOPIC,
                pl.getKafkaKey(), pl);
        ConsumerRecord<byte[], byte[]> glRecord = gapLogFactory.create(GapLogProducer.SIMPLE_JSON_TOPIC,
                gl.getKafkaKey(), gl);
        ...
        GapLogProductionLogSplitRecord glpl = new GapLogProductionLogSplitRecord(gl, pl);
        
        assertThat(producerRecord.key(), is(gl.getKafkaKey()));
        // OutputVerifier.compareValue(producerRecord, glpl);
